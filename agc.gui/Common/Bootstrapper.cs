...
namespace AGC.GUI.Common
{
    public class Bootstrapper
    {
        ...
        private void ConfigureContainer()
        {
            ...
            Container.RegisterType<OthersCalendarViewModel>();
            log.Debug("Registered type of ScheduleMeetingViewModel");

            Container.RegisterType<CompareCalendarsViewModel>();
            log.Debug("Registered type of CompareCalendarsViewModel");
