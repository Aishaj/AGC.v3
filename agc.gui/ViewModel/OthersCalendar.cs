...
{
    public class OthersCalendarViewModel : ViewModelBase
    {
        #region Constants
        ...
        public RelayCommand GetOtherCalendarsCommand { get; private set; }
        ...
        public const string OthersEventsPropertyName = "OthersEvents";
        private CalendarEventList _Otherevents;
        public CalendarEventList OthersEvents
        {
            get
            {
                return _Otherevents;
            ...
            set
            {
                if (_Otherevents == value)
                {
                    return;
                }

                RaisePropertyChanging(OthersEventsPropertyName);
                _Otherevents = value;
                RaisePropertyChanged(OthersEventsPropertyName);
            }
        }


        public const string OthersCalendarListPropertyName = "List";
        private String _OtherCalendarsList ;
        public String OtherCalendarsList
        {
            get
            {
                return _OtherCalendarsList;
            }

            set
            {
                if (_OtherCalendarsList == value)
                {
                  return;
                }

                RaisePropertyChanging(OthersCalendarListPropertyName);
                _OtherCalendarsList = value;
                RaisePropertyChanged(OthersCalendarListPropertyName);
            }
        }
        ...
        {
            OthersEvents = service.GetOthersEvents(calendar, period.Tomorrow(), _OtherCalendarsList);
            OthersEvents = service.FormatEventsDatesStringRepresentation(OthersEvents, repository.GetDateTimePreferences());
            SortAndFilterEvents();
        ...
        {
            OthersEvents = service.GetOthersEvents(calendar, period.ThisWeek(), _OtherCalendarsList);
            OthersEvents = service.FormatEventsDatesStringRepresentation(OthersEvents, repository.GetDateTimePreferences());
            SortAndFilterEvents();
        ...
        {
            OthersEvents = service.GetOthersEvents(calendar, period.NextWeek(), _OtherCalendarsList);
            OthersEvents = service.FormatEventsDatesStringRepresentation(OthersEvents, repository.GetDateTimePreferences());
            SortAndFilterEvents();
