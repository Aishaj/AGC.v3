...
namespace AGC.GUI.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public OthersCalendarViewModel OthersEventsList
        {
            get
            {
                log.Debug("Get ScheduleMeetingViewModel from ViewModelLocator");
                return _bootStrapper.Container.Resolve<OthersCalendarViewModel>();
            }
        }


        public CompareCalendarsViewModel ComparingCalendarsList
        {
            get
            {
                log.Debug("Get CompareCalendarsViewModel from ViewModelLocator");
                return _bootStrapper.Container.Resolve<CompareCalendarsViewModel>();
            }
        }
