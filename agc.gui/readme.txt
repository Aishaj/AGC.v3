...
Other calendar Tab:
This tab allows you to look at other person’s calendar events. First control in this tab is a textbox where you can type the email who you want to retrieve his events. Then there is a go button which will show the results.
Following there is the list (as described in the Event Tab) that will contain the resulted events.
Note: the email owner must be sharing his email with you.

Compare Calendars Tab:
This tab allows you to compare two or more calendars to find mutually occurring times. First control in this tab is a textbox where you can type the emails you want to compare. All the emails must be typed in the text box separated by commas. 
For example (Email1@gmail.com,Email2@gmail.com,Email3@gmail.com) 
Next, you can mark “First email is primary” checkbox to make the comparison based on the first typed email. i.e. only the times that the first email is available will be shown, if the checkbox is unchecked , then all mutual times between any two or more calendars will be suggested. Then, you can choose how the match is going to be by choosing one of the options from the dropdown menu. The options are:
1-All people: This option will give you the times where all given calendars are free. The result will be a list of start and end times. An example of the output would look like:
“Thu 16 9:00 AM 10:30 AM”
Thu 16 1:00PM 3:00PM “
2- Some people: This option will suggest times even if some of the calendars are not available and will indicate who are available. If the entire user is available then “all free” is shown instead of the names. For example
“Thu 16 9:00AM 11:00AM user1 user2”
“Thu 16 12:30 PM 11:30 PM all free” 
“Thu 16 3:00 PM 5:00PM user 2 user 3”
Afterwards, there is the find button which will get the results; next you will have the result list as described in the Event Tab where all suggested times is presented. Following there is a list of controls exactly as described in Event tab as well. The controls are “selected view”, “select Month Period” and “sort and filter”. 
...
The second version was developed by Nikita Abramovs during his summer vacation work in 2014 in the University of Manchester.
contact: nikita.abramovs@gmail.com
It's source code is available on Google Code here:
https://github.com/TheOntologist/AGC/

Current Version was developed by Aisha Jaddoh as a MSc project at the University of Manchester - 2015
contact:  Aisha.Jaddoh at gmail.com

AGC is owned by Professor Robert Stevens how was the supervisor for all the previously mentioned students.
