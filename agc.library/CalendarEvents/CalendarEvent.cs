...
namespace AGC.Library
{
    public class CalendarEvent
    {
        ...
        private const string DEFAULT_DATETIME_FORMAT = "hh:mm tt";
        ...
        {
            return String.Format("{0} . {1} . {2} . {3} . {4} . {5}", this.FormatedStartDate, this.FormatedEndDate, this.Status, this.Title, this.Content, this.Location);
        }
